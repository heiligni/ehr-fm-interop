...
def map_preliminary_batch_stats(
    batch, indices, *, processor: UniFEMRBatchProcessor, max_length: int
):
    """
...
class UniBatchCreator:
    ...
    def add_patient(
        ...
        per_patient_text_tokens = []

        if self.task is not None:
            self.task.start_patient(patient, None)
        ...
        for event in patient["events"]:
            ...
            for measurement in event["measurements"]:
                ...
                features, text_tokens = self.tokenizer.get_feature_codes(
                ...
                per_patient_text_tokens.append(text_tokens)
        ...
        self.text_tokens.extend(
            per_patient_text_tokens[offset : offset + length_to_add]
        )
    ...
    def get_batch_data(self):
        ...
        transformer["text_tokens"] = np.stack(self.text_tokens, axis=0)
